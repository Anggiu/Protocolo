...
class Interfaz(Frame):
    ...
    def createWidgets(self):
        ...
        ack_ckb = Checkbutton(self, variable=self.ack_var, command=self.ack_clicked)
        ...
        enq_ckb = Checkbutton(self, variable=self.enq_var, command=self.enq_clicked )
        ...
        ctr_ckb = Checkbutton(self, variable=self.ctr_var, command=self.ctr_clicked)
        ...
        dat_ckb = Checkbutton(self, variable=self.dat_var, command=self.dat_clicked)
        ...
        ppt_ckb = Checkbutton(self, variable=self.ppt_var, command=self.ppt_clicked)
        ...
        lpr_ckb = Checkbutton(self, variable=self.lpr_var, command=self.lpr_clicked)
